...
## Algorithm
1. Load the dataset and separate features (X) and target (y)
2. Convert categorical data into numerical form (One-Hot Encoding). 
3. Split the dataset into training and testing data.
4. Scale the features and train the SGD Classifier model.
5. Test the model, calculate accuracy, and predict new student placement status.
...
## Output:
<img width="638" height="402" alt="image" src="https://github.com/user-attachments/assets/26432229-c436-4b4f-b153-33a0d65986e0" />
